...
require('lazy').setup({
  ...
  --
  require 'sean.plugins.lint',
  require 'sean.plugins.autopairs',
  require 'sean.plugins.gitsigns', -- adds gitsigns recommend keymaps
  -- require 'sean.plugins.debug',
  -- require 'sean.plugins.indent_line',
  -- require 'sean.plugins.neo-tree',
